...
class CoordinatorLeaseAuthority:
    """One store-stamped coordinator lease observation."""
    ...
    def __post_init__(self) -> None:
        ...
        _validate_sequence_lineage(
            ...
            path="CoordinatorLeaseAuthority",
        )
...
class PreparedInitialRestartIntentClosure:
    ...
    def _validate_lease_lineage(self) -> None:
        ...
        for previous, current in zip(
            ...
            lease_ids.append(current.lease.record.lease_id)
            fencing_tokens.append(current.lease.fencing_token)
