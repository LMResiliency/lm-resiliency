...
- **`torchrun` integration with closed-loop recovery:** Use `lm_resiliency` as the rendezvous backend to detect and localize failures, replace faulty nodes with standbys, and resume training from a recovery-verified checkpoint.
